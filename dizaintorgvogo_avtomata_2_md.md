...
Есть одна книга, которая действительно помогает лучшепонять UML это "UML для Java-программистов" Роберт С. Мартин. Книга очень полезна если вы хотите изучить UML с нуля или хотите освежить свои знания UML. В книге также содержаться похожие упражнения, как проектирование кофе машины.

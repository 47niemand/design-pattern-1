...
Это серия из двух статей будет показывать решение задачи по созданию торгового автомата в Java. Кстати, эта задача может быть решена различными способами. Это также дает возможность пересмотреть принципы проектирования SOLID и ООП паттерны (см. здесь) и уметь использовать их в коде. 
...
Вот полный код торгового автомата, протестируйте код и дайте мне знать, если будут какие-либо ошибки.
